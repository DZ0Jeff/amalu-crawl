...
def crawl_magazinevoce(url, nameOfFile="Magazinevocê", verbose=False):
    ...
    if promotional_price == '':
        details['Preço de venda'] = [remove_whitespaces(price)]
        details['Preço regular'] = [remove_whitespaces(promotional_price)]
    else:
        details['Preço de venda'] = [remove_whitespaces(promotional_price)]
        details['Preço regular'] = [remove_whitespaces(price)]
